...
//     system(comando);
    ...
    cudaMalloc((float**)&Kernel, 25*sizeof(float));
	...
	KernelByN<<<dimGrid, dimBlock>>>(Ncol, Nfil, Dev_I, Dev_O, Kernel, frames-2, 3 * Nfil * Ncol, 5);
    ...
    printf("Rendimiento Global: %4.2f GFLOPS\n", (75.0 * (float) Nfil * (float) Ncol * (float) (frames-2)) / (1000000.0 * TiempoTotal));
    printf("Rendimiento Kernel: %4.2f GFLOPS\n", (75.0 * (float) Nfil * (float) Ncol * (float) (frames-2)) / (1000000.0 * TiempoKernel));
